...
public class Egg extends Enemy {
    ...
    public Egg(Handler handler, int x, int y, int width, int height) {
    ...
    private void initTexture() {
        for (int i = 1; i <= 3; ++i) movingDown.add(Utilities.loadWI("egg_down_" + i));
        for (int i = 1; i <= 3; ++i) movingLeft.add(Utilities.loadWI("egg_left_" + i));
        for (int i = 1; i <= 3; ++i) movingRight.add(Utilities.loadWI("egg_right_" + i));
        for (int i = 1; i <= 3; ++i) movingUp.add(Utilities.loadWI("egg_up_" + i));
